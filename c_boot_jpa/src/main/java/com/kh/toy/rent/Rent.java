...
public class Rent implements Serializable {
	...
	@OneToMany(fetch = FetchType.EAGER, cascade = CascadeType.ALL, mappedBy = "rent")
	...
	public String toString() {
		return "Rent [rmIdx=" + rmIdx + ", title=" + title + ", rentBookCnt=" + rentBookCnt + ", regDate=" + regDate
				+ ", isReturn=" + isReturn + ", rentBooks=" + rentBooks + ", member=" + member + "]";
	}
